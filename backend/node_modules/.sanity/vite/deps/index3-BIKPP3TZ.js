import {
  ...
  usePaneLayout,
  useStructureTool
} from "./chunk-K74XCSG4.js";
import "./chunk-5Y24BVOC.js";
import {
  Box,
  Button2 as Button,
  Card,
...
var paneMap = {
  component: (0, import_react.lazy)(() => import("./_chunks-es-PEKGX5TU.js")),
  document: (0, import_react.lazy)(() => import("./pane-UJT6P4TH.js").then(function(n) {
    return n.pane;
  })),
  documentList: (0, import_react.lazy)(() => import("./pane-UJT6P4TH.js").then(function(n) {
    return n.pane$1;
  })),
  list: (0, import_react.lazy)(() => import("./index2-IGREXGH3.js"))
};
...
//# sourceMappingURL=index3-BIKPP3TZ.js.map
